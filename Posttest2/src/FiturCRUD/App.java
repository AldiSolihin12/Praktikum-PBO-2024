...
public class App {
    ...
    private static void tampilkanMobil(boolean header) {
        ...
        if (listMobil.isEmpty()) {
            ...
            for (int i = 0; i < listMobil.size(); i++) {
                Mobil mobil = listMobil.get(i);
                System.out.println("\nMobil ke-"+ (i+1) + "        ");
                System.out.println("Brand Mobil  : " + mobil.getBrand());
                ...
                System.out.println("Harga Mobil  : Rp." + mobil.getHarga());
                System.out.println("\n-------------------------------------------");
            }
        }
    }
    ...
    private static void editMobil() throws InterruptedException {
        ...
        Mobil mobilBaru = listMobil.get(index);
        mobilBaru.setBrand(brand);
        mobilBaru.setTipe(tipe);
        mobilBaru.setWarna(warna);
        mobilBaru.setTahun(tahun);
